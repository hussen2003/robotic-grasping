# Modified real-time evaluation script for Azure Kinect 
...
def main():
    ...
    logging.info("Azure Kinect started successfully.")
    ...
    net = torch.load(args.network, map_location=device_torch)
    net.eval()
    logging.info(f"Model loaded successfully on {device_torch}.")
